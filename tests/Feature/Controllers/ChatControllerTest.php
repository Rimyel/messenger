...
class ChatControllerTest extends TestCase
{
    ...
    //     $privateChat = Chat::factory()->direct()->create([
    //         'company_id' => $companyData['company']->id
    //     ]);
    //     $privateChat->participants()->attach($user->id, ['role' => 'member']);
    ...
    public function test_admin_can_remove_participants(): void
    {
        ...
        // Act
        $response = $this->actingAs($admin)
            ->deleteJson("/api/chats/{$chat->id}/participants/{$member->id}", [
            ], $this->withApiHeaders());
    ...
    public function test_admin_can_change_participant_role(): void
    {
        ...
        // Act
        $response = $this->actingAs($admin)
            ->putJson("/api/chats/{$chat->id}/participants/{$member->id}/role", [
                'role' => 'admin'
            ], $this->withApiHeaders());

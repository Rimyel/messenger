...
const getVideoUrl = (path: string) => {
    ...
    return `${baseUrl}/video/${encodedFilename}`;
};
...
export function VideoPlayer({
    ...
    React.useEffect(() => {
        ...
        video.addEventListener("seeking", () => setIsBuffering(true));
        video.addEventListener("seeked", () => setIsBuffering(false));
        video.addEventListener("stalled", () => setIsBuffering(true));
        video.addEventListener("suspend", () => setIsBuffering(false));
        ...
        return () => {
            ...
            video.removeEventListener("seeking", () => setIsBuffering(true));
            video.removeEventListener("seeked", () => setIsBuffering(false));
            video.removeEventListener("stalled", () => setIsBuffering(true));
            video.removeEventListener("suspend", () => setIsBuffering(false));
    ...
    return (
        ...
        >
            ...
            <video
                ref={videoRef}
                // src устанавливается динамически в onLoadStart
                poster={poster}
                autoPlay={autoPlay}
                muted={muted}
                playsInline
            ...
            >
                <div className="mb-2 relative">
                    {/* Буфер загрузки */}
                    <div
                        className="absolute h-1.5 bg-white/20 rounded-full"
                        style={{
